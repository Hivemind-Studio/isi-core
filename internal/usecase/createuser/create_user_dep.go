...
type repoUserInterface interface {
	...
	Create(ctx context.Context, tx *sqlx.Tx, name string, email string, password *string, roleId int64, phoneNumber *string, gender string, address string, status int, googleId *string) (id int64, err error)
